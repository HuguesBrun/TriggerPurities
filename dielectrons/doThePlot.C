...
doThePlot(){
    gStyle->SetOptStat(0);
    chain->Add("TnP_doubleElectrons.root");
    ...
    */
    ...
    doAndTheVertexPlot("ID","passPre==1&&other_passPre==1");
    doAndTheVertexPlot("IP","passPre==1&&passIP==1&&other_passPre==1&&other_passIP==1");
    doAndTheVertexPlot("Convs","passPre==1&&passIP==1&&passConvs==1&&other_passPre==1&&other_passIP==1&&other_passConvs==1");
