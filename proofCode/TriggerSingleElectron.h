#ifndef TRIGGERSINGLEELECTRON_H
#define TRIGGERSINGLEELECTRON_H 1
...
class TriggerSingleElectron: public CMSAnalysisSelectorMiniTrees {
 public:
  TriggerSingleElectron(TTree *tree=0);
  virtual ~TriggerSingleElectron() {}
  ...
  ClassDef(TriggerSingleElectron,0);
};
#endif
