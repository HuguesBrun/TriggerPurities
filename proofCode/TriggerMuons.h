#ifndef TRIGGERMUONS_H
#define TRIGGERMUONS_H 1
...
class TriggerMuons: public CMSAnalysisSelectorMiniTrees {
 public:
  TriggerMuons(TTree *tree=0);
  virtual ~TriggerMuons() {}
