...
doAndThePtPlot(TString name, TString cuts){
    ...
    for (int i = 20 ; i <40 ; i++){
        ...
        cout << "cut=" <<Form("pt>%i&&pt<%i&&",i,i+1)+cuts << endl;
        cout << "nbBefore=" << nbBefore << " nbAfter="  << nbAfter << endl;
...
doThePlot(){
    gStyle->SetOptStat(0);
    chain->Add("TnP_singleMuon.root");
  
    
    // function of vertex
    doAndTheVertexPlot("GTK","globalOrTrackerMuon==1");
    doAndTheVertexPlot("kine","globalOrTrackerMuon==1&&(pt>25)");
    doAndTheVertexPlot("GT","(pt>25)&&globalOrTrackerMuonTight==1");
    doAndTheVertexPlot("PF","(pt>25)&&globalOrTrackerMuonTight==1&&PFmuon==1");
    doAndTheVertexPlot("TK","(pt>25)&&globalOrTrackerMuonTight==1&&PFmuon==1&&trackCleaning==1");
    doAndTheVertexPlot("IP","(pt>25)&&globalOrTrackerMuonTight==1&&PFmuon==1&&trackCleaning==1&&passMuonIPcuts==1");
    doAndTheVertexPlot("ISO","(pt>25)&&globalOrTrackerMuonTight==1&&PFmuon==1&&trackCleaning==1&&passMuonIPcuts==1&&passMuonMVA==1");
  
    
    doAndThePtPlot("GTK","globalOrTrackerMuon==1");
    doAndThePtPlot("kine","globalOrTrackerMuon==1&&(pt>10)");
    doAndThePtPlot("GT","(pt>10)&&globalOrTrackerMuonTight==1");
    doAndThePtPlot("PF","(pt>10)&&globalOrTrackerMuonTight==1&&PFmuon==1");
    doAndThePtPlot("TK","(pt>10)&&globalOrTrackerMuonTight==1&&PFmuon==1&&trackCleaning==1");
    doAndThePtPlot("IP","(pt>10)&&globalOrTrackerMuonTight==1&&PFmuon==1&&trackCleaning==1&&passMuonIPcuts==1");
    doAndThePtPlot("ISO","(pt>10)&&globalOrTrackerMuonTight==1&&PFmuon==1&&trackCleaning==1&&passMuonIPcuts==1&&passMuonMVA==1");
